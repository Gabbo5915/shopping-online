<template>
  <div>
              ...
              <li v-for="item in cartList" v-bind:key="item.productId">
                <div class="cart-tab-1">
                  ...
                  <div class="cart-item-pic">
                    <img v-lazy="'static/' + item.productImg" v-bind:alt="item.productName">
                  </div>
    ...
    <Modal :mdShow="modalConfirm" @close="closeModal">
      <p slot="message">Are your sure delete it?</p>
      <div slot="btnGroup">
        <a class="btn btn--m" href="javascript:;" @click="delCart">YES</a>
      ...
      computed: {
        totalPrice() {
          ...
          this.cartList.forEach(item => {
            //console.log("Product price:"+item.productPrice+";product Num:"+item.productNum);
            if (item.checked == "1") {
        ...
        editCart(flag,item){
          if(flag == 'add'){
            ...
            if(item.productNum<=1){
              this.delCartConfirm(item.productId);
              return;
            }
            item.productNum--;
          }else{
