    ...
    <div class="container">
      <div class="checkout-addr">
        ...
        <form  style="margin: 10px">
          <h2>Payment</h2>
          <div>
            <div><input name="cardtype" type="radio" required /> Credit card</div>
            <div><input name="cardtype" type="radio" required /> Debit card</div>
            <div><input name="cardtype" type="radio" required /> Paypal</div>
          </div>
          <br>
          <ul>
            <li>
              <label>Card Name: </label>
              <input type="text" name="cardName" style="background-color: transparent;height:30px" v-model="cardName" />
            </li>
            <br>
            <li>
              <label>Card Num: </label>
              <input type="number" name="cardNum" style="background-color: transparent;height:30px" v-model="cardNum" />
            </li>
            <br>
            <li>
              <label>Expiration: </label>
              <input type="number" name="expiration" style="background-color: transparent;height:30px" v-model="expiration" />
            </li>
            <br>
            <li>
              <label>CVV: </label>
              <input type="number" name="cvv" style="background-color: transparent;height:30px" v-model="cvv" />
            </li>
          </ul>
        </form>
      </div>
      <div class="order-foot-wrap">
        <div class="prev-btn-wrap">
          <router-link class="btn btn--m" to="/orderConfirm">Previous</router-link>
        </div>
        <div class="next-btn-wrap">
          <router-link class="btn btn--m btn--red" to="/finalPage">Place Order</router-link>
        </div>
      </div>
    </div>
  </div>
