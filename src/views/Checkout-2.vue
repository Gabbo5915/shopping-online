              ...
              <li v-for="item in cartList" v-if="item.checked=='1'">
                <div class="cart-tab-1">
                  ...
                  <div class="cart-item-title">
                    <div class="item-name">X{{item.productName}}</div>
...
<script>
  ...
  import axios from 'axios'
    export default {
      ...
      components: {NavBread, NavHeader, NavFooter},
      mounted(){
        this.init();
      },
      filters:{
      ...
      computed:{
        ...
        tax(){
          let tax = this.totalPrice*6/100;
          return tax.toFixed(2);
        },
        orderTotal(){
          return this.totalPrice*106/100-this.discount;
        }
      },
      methods:{
        init(){
